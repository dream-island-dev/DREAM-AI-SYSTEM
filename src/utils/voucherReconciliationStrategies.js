...
const STRATEGIES = [
  {
    ...
    easygoColumns: "מזהה (ת.ז.) · CouponDesc · CouponNo",
...
export const VOUCHER_FLOW_EXPLAINER =
  "מטרה: לוודא שמה שהוזמן בדוח איזיגו מומש בפועל אצל הספק (ולהפך). איזיגו = הזמנות · ספק = מימושים · הפרש במספרים = חריגה לבדיקה";
