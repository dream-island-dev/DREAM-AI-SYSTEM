...
const STRATEGIES: Record<VoucherProviderKey, VoucherReconciliationStrategy> = {
  Nofshonit: {
    ...
    ui: {
      easygoRole: "שוברים שהוזמנו במערכת (טרם מומשו / למימוש)",
      providerRole: "שוברים שמומשו בפועל מול נופשונית",
      joinRule: "מזהה לקוח (דוח ספק) = CouponNo (איזיגו)",
      easygoColumns: "CouponNo · CouponDesc · חברת שוברים",
      providerColumns: "מזהה לקוח · וריאנט · שעת מימוש · אסמכתא",
      packageRule: "וריאנט ↔ CouponDesc (קלאסיק/דלאקס)",
      filterNote: "שורות איזיגו מסוננות לחברת שוברים «נופשונית»",
    },
  },
  Hever: {
    key: "Hever",
