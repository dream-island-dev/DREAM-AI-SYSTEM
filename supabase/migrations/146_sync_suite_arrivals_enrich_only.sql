-- 146_sync_suite_arrivals_enrich_only.sql
-- Optional payload flag enrichOnly=true: matched guests/rooms/bookings get missing
-- fields only — never overwrite non-empty DB values. New guests still INSERT fully.
-- Default enrichOnly=false preserves migration 144 full-sync behaviour.
