-- ============================================================================
-- migration 235: Fix false missing_in_easygo when provider report has multiple
-- redemption lines (אסמכתא) for the same voucher number (Nofshonit pattern).
-- EZGO has one row per CouponNo; extra provider lines re-use the same EasyGo match.
-- ============================================================================
...
BEGIN
  ...
  LOOP
    ...
    IF v_candidate_count = 0 THEN
      -- Nofshonit: multiple אסמכתא lines per מזהה לקוח / CouponNo — re-use prior EasyGo row.
