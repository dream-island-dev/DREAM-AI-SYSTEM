...
```
אורח ב-status pending/expected שכותב מילות מפתח בחדר (מגבות|שמפו|מים|קפסולות|לחדר|ניקיון|נייר|סדין):
